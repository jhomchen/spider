    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            <a href="javascript:void (0)" class="logo">
                ...
                <span class="logo-lg">通用后台管理系统</span>
            </a>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu pull-right">
                                ...
                                <li class="divider"></li>
                                <li><a onclick="exit()"><i class="ace-icon fa fa-power-off"></i>安全退出</a></li>
                                <script>
                                     function exit(){
                                    	 window.location.href="/login/toExit";
                                     }
                                </script>
                            </ul>
                        </li>
        ...
        <div id="content-wrapper" class="content-wrapper">
            ...
            <div class="content-iframe" style="overflow: hidden;">
                <div class="mainContent" id="content-main" style="margin: 10px; margin-bottom: 0; padding: 0;">
                    <iframe id="myFrame" class="LRADMS_iframe" width="100%" height="100%" src="/home/toHome" frameborder="0" data-id="default.html"></iframe>
                </div>
            </div>
        </div>
    </div>
